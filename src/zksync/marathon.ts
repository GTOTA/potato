...
const MARATHON_CONTRACT = '0x2A9096Df9eF41ce9cAc50cfAaCF1151071F975AD'

async function  mintMarathonNFT()
{
    ...
    console.log(`mint:${account.address}  Marathon NFT `)
    ...
    const router_address = MARATHON_CONTRACT
    ...
    let tx = {
        ...
        to: router_address,
        value:  web3.utils.toHex(web3.utils.toWei('0.0002409', 'ether')),
        data: tx_data
    };
