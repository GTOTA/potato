...
async function inscribeMerlin(url) {
    ...
    console.log(`merlin ${account.address}  tokenBalance before: ${formatUnits(eth_balance, 18)}`)
    ...
    const tx_data = '646174613a2c7b2270223a226d72632d3230222c226f70223a226d696e74222c227469636b223a226d6c696e222c22616d74223a2231303030227d'
   ...
   let gas_price = web3.utils.toBN(price)
    ...
    console.log(`${account.address}  TX:  https://scan.merlinchain.io/tx/${raw_tx_hash.transactionHash}`);
